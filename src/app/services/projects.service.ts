...
export class ProjectsService {
  ...
  private getInitialProjects(): Project[] {
    return [
      {
        id: '1',
        nombre: 'Automatización Documentos Funcionales',
        descripcion: 'Aplicación de escritorio desarrollada en Python que automatiza la extracción de requerimientos funcionales desde una intranet institucional mediante técnicas avanzadas de web scraping. Esta solución optimiza significativamente los procesos de los analistas funcionales al automatizar la creación de archivos .docx estandarizados, eliminando completamente la carga manual de datos y reduciendo drásticamente el tiempo de confección de documentos técnicos. La aplicación garantiza consistencia en la documentación y permite a los analistas enfocarse en tareas de mayor valor agregado.',
        descripcionCorta: 'Aplicación Python de escritorio que automatiza la extracción de requerimientos mediante scraping y genera documentos .docx estandarizados, optimizando el trabajo de analistas funcionales.',
        videos: [
          'https://drive.google.com/file/d/1gBcJfihj3RMN0_0mPmd6vCxC3IX5ksaT/view?usp=sharing'
        ],
        // imagenes: [],
        imagenes: [],
        tecnologias: ['Python', 'Web Scraping', 'Beautiful Soup', 'Selenium', 'Python-docx', 'Tkinter', 'Requests'],
        githubUrl: 'https://github.com/Camilo-Silva/AutomatizacionIntranetEmpresaTecnologia.git',
        hostedUrl: 'https://drive.google.com/file/d/1gBcJfihj3RMN0_0mPmd6vCxC3IX5ksaT/view?usp=sharing',
        thumbnailUrl: '/assets/images/project6.png'
      },
      {
        id: '2',
        nombre: 'Sublisa',
